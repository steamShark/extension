...
export function SettingsErrorState({ onRetry, onUseDefaults, showLoading }: Props) {
    ...
    if (showLoading) return <SettingsLoading />;
        ...
        <div className="min-h-[40vh] flex items-center justify-center p-6">
            <Card className="w-full max-w-lg">
                <CardHeader className="flex flex-row items-start gap-3">
                    ...
                    <div>
                        <CardTitle>Couldn’t load your settings</CardTitle>
                        <CardDescription>
                ...
                <CardFooter className="flex flex-wrap gap-2">
                    ...
                    {onUseDefaults && (
                        <Button variant="ghost" onClick={onUseDefaults} className="cursor-pointer">
