...
export function LocalDatabaseLoading() {
    return (
        <div className="min-h-[40vh] flex items-center justify-center p-6">
            <Card className="w-full max-w-lg">
                <CardHeader>
                    <CardTitle>Loading LocalDatabase...</CardTitle>
...
export function LocalDatabaseErrorState({ onRetry, showLoading }: Props) {
    ...
    if (showLoading) return <LocalDatabaseLoading />;
        ...
        <div className="min-h-[40vh] flex items-center justify-center p-6">
            <Card className="w-full max-w-lg">
                <CardHeader className="flex flex-row items-start gap-3">
                    ...
                    <div>
                        <CardTitle>Couldn’t load your Local Database</CardTitle>
                        <CardDescription>
                ...
                <CardContent className="text-sm text-muted-foreground space-y-2">
                    <p>Try again or open the extension local database to configure things manually.</p>
                </CardContent>
